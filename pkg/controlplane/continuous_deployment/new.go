...
func NewManager(tc temporalclient.Client, deploymentPlansClient mrdspb.DeploymentPlansClient) Manager {
	return &manager{
		tc:                    tc,
...
func (d *manager) RunBlocking(ctx context.Context) error {
...
func (m *manager) executeWorkflows(ctx context.Context, deploymentPlan *mrdspb.DeploymentPlanRecord, deployment *mrdspb.Deployment) error {
